...
* Adicionado suporte para pagamento por cartão Elo no Checkout Transparente (obrigado [mixbee](https://wordpress.org/support/users/mixbee/)).
* Removido método depreciado de deposito pelo Banrisul no Checkout Transparente (obrigado [mixbee](https://wordpress.org/support/users/mixbee/)).
* Adicionado suporte a pagamentos com cartão de crédito que usam código de segurança de 5 digitos no Checkout Transparente (obrigado [mixbee](https://wordpress.org/support/users/mixbee/)).
